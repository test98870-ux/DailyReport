...
증권사 리포트와 공시를 여러 사이트에서 모아두고, 제목과 원문 링크 중심으로 보여주는 대시보드 MVP입니다.
...
브라우저에서 `http://127.0.0.1:8000` 으로 접속한 뒤 `지금 수집 실행` 버튼을 누르면 최신 항목이 저장됩니다.
...
매일 오전 7시에 수집을 돌리고 싶다면 cron에서 아래처럼 호출할 수 있습니다.
